	...
	{	
		...
		picture = "\zombies\textures\icovest.paa"; /// this icon fits the vest surprisingly well
		model   = "\zombies\models\vest.p3d"; /// what model does the vest use
		
		class ItemInfo: ItemInfo
		{
			uniformModel   = "\zombies\models\vest.p3d"; /// what model does the vest use
			mass = 20;
			armor = 5*0.2;
			passThrough = 0.8;
		};
