class CfgMovesZombie4: CfgMovesZombie
{
	...
	class States
	{
		...
		class AmovPercMwlkSnonWnonDfr: AmovPercMwlkSnonWnonDf    //pourmarcherdebout
		{
		...
		class AmovPercMrunSnonWnonDf: AmovPercMstpSnonWnonDnon    //pourcourrirdebout
		{
			...
			file = "\zombies\zmb\zmbErcSprint13";
			speed = 0.8135;
