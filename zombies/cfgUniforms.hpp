	...
	class U_Test_uniform: Itemcore
	{
		...
		picture = "\zombies\textures\icosurvivorunif.paa"; /// this icon fits the uniform surprisingly well
	...
	class U_zed_uniform: Itemcore
	{
		...
		picture = "\zombies\textures\icocopsunif.paa"; /// this icon fits the uniform surprisingly well
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver"; /// how does the uniform look when put on ground
	...
	class U_officer_uniform: Itemcore
	{
		...
		picture = "\zombies\textures\icoofficerunif.paa"; /// this icon fits the uniform surprisingly well
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver"; /// how does the uniform look when put on ground
	...
	class U_zedwoman_uniform: Itemcore
	{
		...
		picture = "\zombies\textures\icozedwomanunif.paa"; /// this icon fits the uniform surprisingly well
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver"; /// how does the uniform look when put on ground
	...
	class U_zedmalebig_uniform: Itemcore
	{
		...
		picture = "\zombies\textures\icozedmalebigunif.paa"; /// this icon fits the uniform surprisingly well
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver"; /// how does the uniform look when put on ground
	...
	class U_zedmedic_uniform: Itemcore
	{
		...
		picture = "\zombies\textures\icomedicunif.paa"; /// this icon fits the uniform surprisingly well
		model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver"; /// how does the uniform look when put on ground
