	...
	class DN_zedcap: ItemCore
	{
		...
		picture = "\zombies\textures\icopolicecap.paa"; /// this looks fairly similar
		model   = "\zombies\models\casque.p3d"; /// what model does the cap use
		hiddenSelections[] = {"camo"}; /// what selection in model could have different textures
		hiddenSelectionsTextures[] = {"\zombies\textures\Zombie_Policeman_head.paa"}; /// what texture is going to be used
		class ItemInfo : HeadgearItem
		{
			mass = 10; /// combined weight and volume of the cap, this equals to single magazine
			uniformModel = "\zombies\models\casque.p3d";	/// what model is used for this cap
	...
	class DN_hatofficer: ItemCore
	{
		...
		picture = "\zombies\textures\icohat.paa"; /// this looks fairly similar
		model   = "\zombies\models\hatofficer.p3d"; /// what model does the cap use
		hiddenSelections[] = {"camo"}; /// what selection in model could have different textures
		hiddenSelectionsTextures[] = {"\zombies\textures\hat_officer.paa"}; /// what texture is going to be used
		class ItemInfo : HeadgearItem
		{
			mass = 10; /// combined weight and volume of the cap, this equals to single magazine
			uniformModel = "\zombies\models\hatofficer.p3d";	/// what model is used for this cap
			allowedSlots[] = {UNIFORM_SLOT, BACKPACK_SLOT, VEST_SLOT, HEADGEAR_SLOT};	/// this cap is so small and flexible that it fits everywhere
			modelSides[] = {6}; /// available for all sides
			armor = 0;	/// this cap doesn't provide any protection
			passThrough = 1; /// this cap doesn't provide any protection
	...
	class DN_maskmed: ItemCore
	{
		scope = 2; /// scope needs to be 2 to have a visible class
		displayName  = "Officer Hat"; /// how would the stuff be displayed in inventory and on ground
		picture = "\zombies\textures\icomaskmedic.paa"; /// this looks fairly similar
		model   = "\zombies\models\maskmed.p3d"; /// what model does the cap use
		hiddenSelections[] = {"camo"}; /// what selection in model could have different textures
		hiddenSelectionsTextures[] = {"\zombies\textures\medicmask.paa"}; /// what texture is going to be used
		class ItemInfo : HeadgearItem
		{
			mass = 10; /// combined weight and volume of the cap, this equals to single magazine
			uniformModel = "\zombies\models\maskmed.p3d";	/// what model is used for this cap
			allowedSlots[] = {UNIFORM_SLOT, BACKPACK_SLOT, VEST_SLOT, HEADGEAR_SLOT};	/// this cap is so small and flexible that it fits everywhere
			modelSides[] = {6}; /// available for all sides
			armor = 0;	/// this cap doesn't provide any protection
			passThrough = 1; /// this cap doesn't provide any protection
